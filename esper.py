...
class World:
    def __init__(self, timed=False):
        """A World object keeps track of all Entities, Components,
        and Processors.
    ...
    def get_processor(self, processor_type):
        ...
        :return: A Processor instance that has previously been added to the
        World.
        """
        for processor in self._processors:
            if type(processor) == processor_type:
    ...
    def process(self, *args):
        """Call the process method on all Processors, in order of their
        priority.
